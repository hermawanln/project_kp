...
class Crud extends CI_Controller {
    ...
    public function app() {
     ...
     public function keg_kemenkeu() {
        ...
        $crud->callback_add_field('nama_pemohon', function($value){
        ...
        $crud->callback_add_field('nomor_surat', function($value){
        ...
        $crud->callback_add_field('kegiatan1', function($value) {
        ...
        $crud->callback_add_field('kegiatan2', function($value) {
        ...
        $crud->callback_add_field('kegiatan3', function($value) {
        ...
        $crud->callback_add_field('kegiatan4', function($value) {
        ...
        $crud->callback_add_field('kegiatan5', function($value) {
